...
use Framework\Router\Exception\RouterBadMethodCallException;
...
class Router implements RouterInterface
{
    ...
    */
    public function dispatch(string $url): void
    {
        if ($this->match($url)) {
            ...
            $controllerString = $this->transformUpperCamelCase($controllerString); // example UserController
    ...
    /**
     * Example convert : blog-post/ => BlogPost
     *
     * @param string $string
     * @return string
    */
    ...
    */
    ...
    /**
     * Get the namespace for controller class. the namespace defined within the route parameters
